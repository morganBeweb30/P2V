...
let quizTech = [{
    ...
    "ask": "Quel langage permet de rendre des pages web dynamiques ?",
    "choice": ["PHP", "JavaScript"],
    "correct": "JavaScript"
  }, {
    "ask": "Quel vallée des états-unis est réputée pour ses innovations ?",
    "choice": ["Silicon Valley", "Death Valley"],
    "correct": "Silicon Valley"
  }, {
    "ask": "Quel pays a accordé la citoyenneté à un robot ?",
    "choice": ["La Corée du Nord", "L'Arabie Saoudite"],
    "correct": "L'Arabie Saoudite"
  }, {
    "ask": "Lequel de ces deux sites est le plus vieux ?",
    "choice": ["Twitter", "Facebook"],
    "correct": "Facebook"
  }, {
    "ask": "En quelle année le premier iPhone est apparu ?",
    "choice": ["2001", "2007"],
    "correct": "2007"
  }, {
    ...
    "ask": "A quelle date remonte la conception de l'HDMI ?",
    "choice": ["2002", "2006"],
    "correct": "2002"
  }, {
    ...
    "ask": "Quelle est l'utilité d'un serveur NAS ?",
    ...
    "ask": "Quel débit internet est plus rapide ?",
    "choice": ["400M/s", "1Gb/s"],
    "correct": "1Gb/s"
  }, {
    "ask": "Quelle extension définit un fichier de compression ?",
    "choice": [".pdf", ".zip"],
    "correct": ".zip"
  }, {
    "ask": "Quelle est l'entreprise créatrice de la XBOX ?",
    ...
    "ask": "Cisco et Arbor sont quel type de société ?",
    ...
    "ask": "Lequel de ces deux sites a été créé par Kim Dot Com ?",
    "choice": ["The Pirate Bay", "Megaupload"],
    "correct": "Megaupload"
  }, {
    "ask": "Quelle société a créé Photoshop ?",
    "choice": ["Adobe", "Google"],
    "correct": "Adobe"
  }, {
    "ask": "Quelle unité de mesure utilise-t-on pour mesurer la puissance d'un processeur ?",
    "choice": ["GHz", "Gb/s"],
    "correct": "GHz"
  }, {
    ...
    "ask": "Un Black-Hat est considéré comme ?",
    "choice": ["Mauvais Hacker", "Bon Hacker"],
    "correct": "Mauvais Hacker"
  }, {
    "ask": "La fsociety est une organisation réelle ?",
    "choice": ["Vrai", "Faux"],
    "correct": "Faux"
  }, {
    "ask": "YouTube est une plate-forme de ?",
    "choice": ["Vidéastes", "Film & Série"],
    "correct": "Vidéastes"
  }, {
    "ask": "Certains smarthphones ont-ils une reconnaissance digitale ?",
    "choice": ["Oui, certains", "Impossible"],
    "correct": "Oui, certains"
  }]
